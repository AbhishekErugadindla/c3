...
const FetchData = ({ cat }) => {
  ...
  const apiUrl = cat
    ? `https://gnews.io/api/v4/top-headlines?country=in&topic=${cat}&lang=en&token=6aee31f0c23a50784f1632e3e95438b0`
    : `https://gnews.io/api/v4/top-headlines?country=in&lang=en&token=6aee31f0c23a50784f1632e3e95438b0`;
